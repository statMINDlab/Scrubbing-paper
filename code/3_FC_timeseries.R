...
# Who: Damon Pham
# When: Spring 2024
# What: Compute FC parcellated time series
# How: First 1_MeanSignals.R, 1_ParcMatLabels.R, 2_ScrubMeas_DVARS.R, and 2_ScrubMeas_FD.R must be run
